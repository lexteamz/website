...
addCustomFeature("Acknowledgements", `LInjector is diligently maintained by Excel and Depso, who consistently strive to elevate the overall user experience.<br>Thanks to <span onclick='GoToUrl("https://github.com/MoistMonkey420/MicrosoftRobloxFluxAPI");' id=GitHubCredits' style='color: white; cursor: pointer;'' class='hov-und-anm'>MoistMonkey420</span> for sharing this Module interfacer.<br><br>— Made with love by Excel and Depso. <3`);
